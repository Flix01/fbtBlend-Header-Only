...
struct KeyframeActionStrip	{
	ActionStrip	strip;
	ActionChannelBag	**channelbags_array;
...
struct AssetShelfSettings	{
	AssetShelfSettings	*next;
	AssetShelfSettings	*prev;
...
struct ThemeSpace	{
	...
	char	keytype_generated_select[4];
	char	keyborder[4];
