...
struct Simulation	{
	...
	char	_pad[4];
	ListBase	states;
	ListBase	persistent_data_handles;
};
...
struct ParticleMeshEmitterSimulationState	{
	SimulationState	head;
	float	last_birth_time;
	char	_pad[4];
};

struct PersistentDataHandleItem	{
	PersistentDataHandleItem	*next;
	PersistentDataHandleItem	*prev;
	ID	*id;
	int	handle;
	char	_pad[4];
};
